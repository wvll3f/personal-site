export type EventsTextProps ={
    heading:string,
    subHeading:string,
    direction:string,
};

export const EventsText:EventsTextProps[] = [
    {
        heading: "IFBA - 2017 ~ 2020",
        subHeading: "Primeiro contato com o mundo do desenvolvimento e muito conhecimento teórico na área da tecnologia.",
        direction: "right"
    },
    {
