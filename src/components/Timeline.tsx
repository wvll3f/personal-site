...
const CardEvent = ({ heading, subHeading }: timelineProps) => {
    return (
        <div className='bg-gradient-to-tr from-slate-100 flex flex-col max-w-[500px] gap-y-2 border-b-2 border-t-slate-50 border-t-2 shadow-md rounded-xl p-4 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-2xl'>
